          ...
          <div>
            ...
            <div className="container">
                ...
                <div className="col-lg-9">
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-6">
                        <div className="product__item">
                        <div className="product__item__pic set-bg" style ={ { backgroundImage: "url('assets/img/product/product-9.jpg')" } }>
                            <ul className="product__hover">
                            <li><a href="#"><img src="assets/img/icon/heart.png" alt="" /></a></li>
                            <li><a href="#"><img src="assets/img/icon/compare.png" alt="" /> <span>Compare</span></a>
                            </li>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-6">
                        <div className="product__item sale">
                        <div className="product__item__pic set-bg" style ={ { backgroundImage: "url('assets/img/product/product-10.jpg')" } }>
                            <span className="label">Sale</span>
                            <ul className="product__hover">
                            <li><a href="#"><img src="assets/img/icon/heart.png" alt="" /></a></li>
                            <li><a href="#"><img src="assets/img/icon/compare.png" alt="" /> <span>Compare</span></a>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-6">
                        <div className="product__item">
                        <div className="product__item__pic set-bg" style ={ { backgroundImage: "url('assets/img/product/product-11.jpg')" } }>
                            <ul className="product__hover">
                            <li><a href="#"><img src="assets/img/icon/heart.png" alt="" /></a></li>
                            <li><a href="#"><img src="assets/img/icon/compare.png" alt="" /> <span>Compare</span></a>
                            </li>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-6">
                        <div className="product__item sale">
                        <div className="product__item__pic set-bg" style ={ { backgroundImage: "url('assets/img/product/product-12.jpg')" } }>
                            <span className="label">Sale</span>
                            <ul className="product__hover">
                            <li><a href="#"><img src="assets/img/icon/heart.png" alt="" /></a></li>
                            <li><a href="#"><img src="assets/img/icon/compare.png" alt="" /> <span>Compare</span></a>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-6">
                        <div className="product__item">
                        <div className="product__item__pic set-bg" style ={ { backgroundImage: "url('assets/img/product/product-13.jpg')" } }>
                            <ul className="product__hover">
                            <li><a href="#"><img src="assets/img/icon/heart.png" alt="" /></a></li>
                            <li><a href="#"><img src="assets/img/icon/compare.png" alt="" /> <span>Compare</span></a>
                            </li>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-6">
                        <div className="product__item">
                        <div className="product__item__pic set-bg" style ={ { backgroundImage: "url('assets/img/product/product-14.jpg')" } }>
                            <ul className="product__hover">
                            <li><a href="#"><img src="assets/img/icon/heart.png" alt="" /></a></li>
                            <li><a href="#"><img src="assets/img/icon/compare.png" alt="" /> <span>Compare</span></a>
                            </li>
